...
export default function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Our standard medical director fees start at $799 per month. The exact fee can vary depending on the specific requirements of your practice and the complexity of medical oversight needed."
    },
    {
