...
export default function WhyChooseUsSection() {
  const features = [
    { 
      ...
      title: "We are a nurse owned business" 
    },
    { 
    ...
    { 
      ...
      title: "We handle all state requirements" 
    }
  ]
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-primary-dark mb-6">
              EliteUSMD is a streamlined service that helps nurses and medical professionals hire collaborative physicians. 
              We are fast, knowledgeable, and we are a nurse-owned business. We see the clinics from the perspective of 
              their nurse founders and only select the most qualified medical directors for hire.
            </p>
