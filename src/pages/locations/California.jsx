...
export default function California() {
  const cities = [
    ...
    {
      name: "San Diego",
      path: "/locations/california/san-diego",
      image: "https://images.pexels.com/photos/1538177/pexels-photo-1538177.jpeg",
      description: "Expert medical direction for Southern California practices."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-12">
          ...
          <p className="text-primary-dark mb-6">
            EliteUSMD provides comprehensive medical director services tailored to California's unique healthcare regulations. 
            Our board-certified physicians specialize in supporting aesthetic practices across the state.
          </p>
          <ul className="space-y-3 text-primary-dark mb-8">
            <li>• Compliance with California Medical Board regulations</li>
